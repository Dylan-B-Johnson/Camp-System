...
public class DataReaderTest {
        ...
        public void setup() {
                ...
                customers.add(new Customer("test@test.test", "firstName", "lastName", "password",
                                ...
                                new Contact("firstName", "lastName", "test@test.test", "8034772355", "mom",
                                                "101 test dr")));
        ...
        void testGetCustomer() {
                ...
                assertEquals(customers.get(0).getCampers().get(0).getFirstName(),
                                DataReader.getCustomers().values().iterator().next().getCampers().get(0)
                                                .getFirstName());
                assertEquals(customers.get(0).getFirstName(),
                                DataReader.getCustomers().values().iterator().next().getFirstName());
        ...
        void testGetCamper() {
                assertEquals(campers.get(0).getFirstName(),
                                DataReader.getCampers().values().iterator().next().getFirstName());
                assertEquals(campers.get(0).getLastName(),
                                DataReader.getCampers().values().iterator().next().getLastName());
                assertEquals(campers.get(0).getAllergies().size(),
                                DataReader.getCampers().values().iterator().next().getAllergies().size());
                assertEquals(campers.get(0).getBirthday(),
                                DataReader.getCampers().values().iterator().next().getBirthday());
                assertEquals(campers.get(0).getPrimaryEmergencyContact().getFirstName(),
                                DataReader.getCampers().values().iterator().next().getPrimaryEmergencyContact()
                                                .getFirstName());
                assertEquals(campers.get(0).getSecondaryEmergencyContact().getFirstName(),
                                DataReader.getCampers().values().iterator().next().getSecondaryEmergencyContact()
                                                .getFirstName());
                assertEquals(campers.get(0).getPrimaryCarePhysician().getFirstName(),
                                DataReader.getCampers().values().iterator().next().getPrimaryCarePhysician()
                                                .getFirstName());
        ...
        void testGetCounselor() {
                ...
                assertEquals(counselors.get(0).getPrimaryEmergencyContact().getFirstName(),
                                DataReader.getCounselors().values().iterator().next().getPrimaryEmergencyContact()
                                                .getFirstName());
                assertEquals(counselors.get(0).getSecondaryEmergencyContact().getFirstName(),
                                DataReader.getCounselors().values().iterator().next().getSecondaryEmergencyContact()
                                                .getFirstName());
                assertEquals(counselors.get(0).getPrimaryCarePhysician().getFirstName(),
                                DataReader.getCounselors().values().iterator().next().getPrimaryCarePhysician()
                                                .getFirstName());
        }
        ...
        void testGetActivity() {
                assertEquals(activities.get(0).getName(),
                                DataReader.getActivities().values().iterator().next().getName());
        ...
        @Test
        void testGetWeek() {
                assertEquals(weeks.get(0).getMaxCampers(),
                                DataReader.getWeeks().values().iterator().next().getMaxCampers());
                assertEquals(weeks.get(0).getCurrentCampers(),
                                DataReader.getWeeks().values().iterator().next().getCurrentCampers());
                assertEquals(weeks.get(0).getStartOfWeek(),
                                DataReader.getWeeks().values().iterator().next().getStartOfWeek());
        ...
        void testGetDaySchedule() {
                assertEquals(daySchedules.get(0).getCurrentAcitivities().get(0).getDescription(),
                                DataReader.getDaySchedules()
                                                .values().iterator().next().getCurrentAcitivities().get(0)
                                                .getDescription());
        ...
        void testGetDirector() {
                ...
                assertEquals(director.getCampLocation().getName(),
                                DataReader.getDirector().getCampLocation().getName());
        }
}
